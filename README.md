...
[![codecov](https://codecov.io/gh/rodrigowmendes/fastapi-project-template/branch/main/graph/badge.svg?token=fastapi-project-template_token_here)](https://codecov.io/gh/rodrigowmendes/fastapi-project-template)
[![CI](https://github.com/rodrigowmendes/fastapi-project-template/actions/workflows/main.yml/badge.svg)](https://github.com/rodrigowmendes/fastapi-project-template/actions/workflows/main.yml)

Awesome fastapi_project_template created by rodrigowmendes

## Install

from source
```bash
git clone https://github.com/rodrigowmendes/fastapi-project-template fastapi_project_template
