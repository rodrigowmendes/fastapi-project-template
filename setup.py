...
setup(
    ...
    description="Awesome fastapi_project_template created by rodrigowmendes",
    url="https://github.com/rodrigowmendes/fastapi-project-template/",
    long_description=read("README.md"),
    long_description_content_type="text/markdown",
    author="rodrigowmendes",
